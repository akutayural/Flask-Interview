    ...
    def login():
        if request.method == 'POST':
            ...
            if status == "APPROVED":
                token = r.json()['token']
                session['token'] = token
                return '''Login Successful! Status = ''' + status + ''' Generated Token from the endpoint ''' + token + '''<a href="https://akutayural.github.io/Flask-Interview/templates/getClient">Click here for Client Info.</a>''' + ''' <a href="https://akutayural.github.io/Flask-Interview/templates/getTransaction">Click here to Get Transaction Information.</a> ''' + ''' <a href="https://akutayural.github.io/Flask-Interview/templates/transactionQuery">Click here for Transaction Query.</a> '''
